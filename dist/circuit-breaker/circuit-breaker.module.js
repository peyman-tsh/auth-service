...
const circuit_breaker_interceptor_1 = require("./interceptors/circuit-breaker.interceptor");
...
exports.CircuitBreakerModule = CircuitBreakerModule = __decorate([
    (0, common_1.Module)({
        providers: [circuit_breaker_interceptor_1.CircuitBreakerInterceptor],
        exports: [circuit_breaker_interceptor_1.CircuitBreakerInterceptor],
    })
